...
Now a similar argument, but this time consider the parameter of interest to be $f_{i'j}$, the $(i=i')$\textsuperscript{th} entry of the $n$-vector formed by taking the inner product of $\pmb{X}$ with $\alpha_j$ and applying $f$ to each entry.
